...
import { MapPinIcon, PlusSmallIcon, UserIcon } from "@heroicons/react/24/solid";
...
const Person = () => {
  ...
  const [credits, setCredits] = useState<
    ApiResponse<PersonCombinedCreditsResponse>
  >({
    status: "pending",
  });
        ...
        <div className="mx-auto max-w-7xl items-center px-4 py-8 sm:flex sm:px-6 lg:px-8">
          ...
          <div className="mt-6 sm:mt-0 sm:ml-10">
            ...
            <div className="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap sm:space-x-6">
              ...
              <div className="mt-2 flex items-center text-sm font-light text-gray-200">
                ...
                {person.status === "pending" ? (
                  ...
                  <>
                    ...
                    {formatAge(person.data.birthday, person.data.deathday)}{" "}
                    years old
                  </>
                ) : (
                  `Unknown birthday`
              ...
              <div className="mt-2 flex items-center text-sm font-light text-gray-200">
                <MapPinIcon className="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-300" />
            ...
            <div className="mt-6">
              {person.status === "pending" ? (
                ...
                >
                  <PlusSmallIcon className="mr-2 -ml-1 h-5 w-5" />
                  Add to list
                </button>
              ) : null}
            </div>
            ...
            <div className="mt-6">
              <h3 className="text-lg font-bold italic text-gray-200">
                Biography
              </h3>
              {person.status === "pending" ? (
